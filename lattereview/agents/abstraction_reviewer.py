...
class AbstractionReviewer(BaseAgent):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        try:
            self.reasoning = ReasoningType.NONE # Reasoning is not supported for abstraction review
            prompt_path = Path(__file__).parent.parent / "generic_prompts" / "abstraction_review_prompt.txt"
    ...
    def setup(self) -> None:
        ...
        try:
            ...
            keys_to_replace = ["response_format", "instructions", "examples"]
