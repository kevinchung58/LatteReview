...
function App() {
  return (
    <div className="app-container" style={{ maxWidth: '900px', margin: '20px auto', padding: '0 20px' }}>
      ...
      <main className="app-main">
        <section id="file-upload-section" className="card">
          {/* h2 style marginTop: '0' will be inherited from global h2 style if defined, or can be added as utility class */}
